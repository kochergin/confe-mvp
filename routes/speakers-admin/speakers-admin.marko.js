...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/marko-express$0.0.1/routes/speakers-admin/speakers-admin.marko",
    ...
    speakers_admin_content_template = require("./components/speakers-admin-content.marko"),
    speakers_admin_content_tag = marko_loadTag(speakers_admin_content_template),
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!doctype html><html lang=\"ru\" id=\"nojs\"><head><meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\"> <title>Администрирование - команда</title>");
  ...
  speakers_admin_content_tag({
      fingerprint: data.fingerprint,
      admin_speakers: data.admin_speakers
    }, out, __component, "10");
...
marko_template.meta = {
    id: "/marko-express$0.0.1/routes/speakers-admin/speakers-admin.marko",
    tags: [
      "@lasso/marko-taglib/taglib/config-tag",
      "@lasso/marko-taglib/taglib/head-tag",
      "marko/src/core-tags/components/component-globals-tag",
      "../../components/presentation-admin-nav",
      "./components/speakers-admin-content.marko",
