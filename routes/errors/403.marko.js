...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/marko-express$0.0.1/routes/errors/403.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!doctype html><html lang=\"ru\" id=\"nojs\"><head><meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\"> <title>Доступ запрещён</title>");
  ...
  out.w("<div class=\"container-fluid\"><div class=\"py-2\"><h2>Ошибка 403 - Доступ запрещён</h2> <p>Вам запрещён доступ к данной странице.</p> </div></div>");
...
marko_template.meta = {
    id: "/marko-express$0.0.1/routes/errors/403.marko",
    tags: [
