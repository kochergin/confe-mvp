...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/marko-express$0.0.1/routes/speakers/speakers.marko",
    ...
    speakers_content_template = require("./components/speakers-content.marko"),
    speakers_content_tag = marko_loadTag(speakers_content_template),
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!doctype html><html lang=\"ru\" id=\"nojs\"><head><meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\"> <title>Наша команда - " +
...
marko_template.meta = {
    id: "/marko-express$0.0.1/routes/speakers/speakers.marko",
    tags: [
      "@lasso/marko-taglib/taglib/config-tag",
      "@lasso/marko-taglib/taglib/head-tag",
      "marko/src/core-tags/components/component-globals-tag",
      "../../components/presentation-nav",
      "./components/speakers-content.marko",
