...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/marko-express$0.0.1/routes/feedback/feedback.marko",
    ...
    feedback_blocks_template = require("./components/feedback-blocks.marko"),
    feedback_blocks_tag = marko_loadTag(feedback_blocks_template),
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!doctype html><html lang=\"ru\" id=\"nojs\"><head><meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\"> <title>Обратная связь - " +
  ...
  out.w("<div class=\"container\"><div class=\"py-2\"><div class=\"border border-primary mb-2\"><div class=\"row no-gutters\"><div class=\"col-12 bg-primary\"><p class=\"px-2 py-1 m-0 text-light text-uppercase\">Обратная связь</p> </div> </div> </div> ");
...
marko_template.meta = {
    id: "/marko-express$0.0.1/routes/feedback/feedback.marko",
    tags: [
      "@lasso/marko-taglib/taglib/config-tag",
      "@lasso/marko-taglib/taglib/head-tag",
      "marko/src/core-tags/components/component-globals-tag",
      "../../components/presentation-nav",
      "./components/feedback-blocks.marko",
