...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/marko-express$0.0.1/routes/schedule-admin/schedule-admin.marko",
    ...
    schedule_admin_calendar_template = require("./components/schedule-admin-calendar.marko"),
    schedule_admin_calendar_tag = marko_loadTag(schedule_admin_calendar_template),
...
function render(input, out, __component, component, state) {
  ...
  out.w("<!doctype html><html lang=\"ru\" id=\"nojs\"><head><meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\"> <title>Администрирование - программа конференции</title>");
  ...
  schedule_admin_calendar_tag({
      fingerprint: data.fingerprint,
      is_admin: data.is_admin,
      admin_schedule: data.admin_schedule,
...
marko_template.meta = {
    id: "/marko-express$0.0.1/routes/schedule-admin/schedule-admin.marko",
    tags: [
      "@lasso/marko-taglib/taglib/config-tag",
      "@lasso/marko-taglib/taglib/head-tag",
      "marko/src/core-tags/components/component-globals-tag",
      "../../components/presentation-admin-nav",
      "./components/schedule-admin-calendar.marko",
